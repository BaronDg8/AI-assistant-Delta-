...
Cortana Manager Executable
 ...
 # pyinstaller --noconsole manager.py --icon=cortana.png --add-data "voice_activation.py;." --add-data "resource_notifier.py;." --add-data "Delta.py;." --add-data "Delta_log_cache.txt;." --add-data "notifier_log.txt;." --add-data "chat_room.py;." --add-data "mic_system.py;." --add-data "mouth.py;." --add-data "commands.json;." --add-data "settings.json;." --add-data "ignore_config.json;." --add-data "cortana.png;."
"""
